...
import com.autoexsel.mobile.wrapper.AppiumAppElement;
import com.autoexsel.mobile.wrapper.AppiumMobileElement;

import io.appium.java_client.MobileBy;
import io.appium.java_client.MobileElement;

public class FindAppiumAppElement extends AppiumDriverBase implements FindAppiumMobileElement {
	private AppiumMobileDriver appiumMobileDriver = null;
	private By locator;
	private String orSeparator = "==";

	public FindAppiumAppElement(AppiumMobileDriver appiumMobileDriver) {
	...
	public AppiumMobileElement byAny(MobileElement element) {
		...
		appiumMobileElement = new AppiumAppElement(appiumMobileDriver);
